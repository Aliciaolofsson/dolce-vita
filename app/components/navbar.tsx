...
export default function Navbar() {
  return (
    <nav className='fixed z-50 bg-white md:static text-primary flex justify-between uppercase items-center md:px-10 xl:px-32 px-8 py-6 md:py-10 text-lg w-full'>
